        ...
        <div class="loginCon">
          <el-card shadow="always" class="login-module" v-if="smdl">
            <div slot="header" class="clearfix formTitlt">
              ...
              <i class="iconfont xu-saomadenglu01 el-icon--right fa-lg pointer" @click="smdl = !smdl">xx</i>
            </span>
            </div>
          ...
          <el-card shadow="always" class="login-module" v-else>
            <div slot="header" class="clearfix formTitlt">
              ...
              <i class="iconfont xu-imagevector el-icon--right fa-lg pointer" @click="smdl = !smdl">cc</i>
            </span>
            </div>
            <div class="ewmbox">
              <div class="ewm">
